...
<body>
  ...
  <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            <label for="updateename" class="form-label">User Name</label>
            <input type="text" class="form-control" id="updateename" placeholder="Enter Name">
          </div>
          <div class="mb-3">
  ...
  <div class="container my-3">
    ...
    <button type="button" class="btn btn-dark" id="btn" data-toggle="modal" data-target="#completeModal">
      Add New User
    </button>
